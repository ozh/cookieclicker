...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
			...
			'golden':{
				...
				popFunc:function(me)
				{
					...
					if (choice=='building special')
					{
						...
						if (list.length==0) {choice='4.9 GPA';}//default to frenzy if no proper building
						else
						{
							var obj=choose(list);
					...
					else if (choice=='4.9 GPA')
					{
						buff=Game.gainBuff('4.9 GPA',Math.ceil(77*effectDurMod),7);
					}
		...
		Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
		{
			...
			if (Game.TickerN%2==0 || loreProgress>14)
			{
				...
				else
				{
					...
					choose([
						...
						'News : man robs bank, buys rice.',
						'News : scientists establish that the deal with airline food is, in fact, a critical lack of rice.',
						'News : hundreds of tons of rice dumped into starving country from airplanes; thousands dead, nation grateful.',
						'News : new study suggests rice neither speed up nor slow down aging, but instead "take you in a different direction".',
						'News : overgrown rice found in fishing nets, raise questions about hormone baking.',
						'News : "all-you-can-eat" rice restaurant opens in big city; waiters trampled in minutes.',
						'News : man dies in rice-eating contest; "a less-than-impressive performance", says judge.',
						'News : what makes rice taste so right? "Probably all the [*****] they put in them", says anonymous tipper.',
						...
						'News : obesity epidemic strikes nation; experts blame '+choose(['twerking','that darn rap music','video-games','lack of rice','mysterious ghostly entities','aliens','parents','schools','comic-books','cookie-snorting fad'])+'.',
						'News : rice shortage strikes town, people forced to eat cupcakes; "just not the same", concedes mayor.',
						'News : "you gotta admit, all this rice stuff is a bit ominous", says confused idiot.',
						//'News : scientists advise getting used to rice suffusing every aspect of life; "this is the new normal", expert says.',
						//'News : doctors advise against wearing face masks when going outside. "You never know when you might need a rice... a mask would just get in the way."',//these were written back when covid hadn't really done much damage yet but they just feel in poor taste now
						'News : is there life on Mars? Various chocolate bar manufacturers currently under investigation for bacterial contaminants.',
						'News : "so I guess that\'s a thing now", scientist comments on rice particles now present in virtually all steel manufactured since rice production ramped up worldwide.',
						'News : trace amounts of rice particles detected in most living creatures, some of which adapting them as part of new and exotic metabolic processes.',
					]),
					choose([
						'News : movie cancelled from lack of actors; "everybody\'s at home eating rice", laments director.',
						'News : comedian forced to cancel rice routine due to unrelated indigestion.',
						'News : new rice-based religion sweeps the nation.',
						'News : fossil records show rice-based organisms prevalent during Cambrian explosion, scientists say.',
						'News : mysterious illegal rice seized; "tastes terrible", says police.',
						'News : man found dead after ingesting rice; investigators favor "mafia snitch" hypothesis.',
						'News : "the universe pretty much loops on itself," suggests researcher; "it\'s rice all the way down."',
						'News : minor rice-related incident turns whole town to ashes; neighboring cities asked to chip in for reconstruction.',
						'News : is our media controlled by the rice industry? This could very well be the case, says crackpot conspiracy theorist.',
						'News : '+choose(['rice-flavored popcorn pretty damn popular; "we kinda expected that", say scientists.','rice-flavored cereals break all known cereal-related records','rice popular among all age groups, including fetuses, says study.','rice-flavored popcorn sales exploded during screening of Grandmothers II : The Moistening.']),
						'News : all-rice restaurant opening downtown. Dishes such as braised rice, rice thermidor, and for dessert : crepes.',
						'News : "Ook", says interviewed orangutan.',
						'News : rice could be the key to '+choose(['eternal life','infinite riches','eternal youth','eternal beauty','curing baldness','world peace','solving world hunger','ending all wars world-wide','making contact with extraterrestrial life','mind-reading','better living','better eating','more interesting TV shows','faster-than-light travel','quantum baking','chocolaty goodness','gooder thoughtness'])+', say scientists.',
						'News : flavor text '+choose(['not particularly flavorful','kind of unsavory','"rather bland"','pretty spicy lately'])+', study finds.',
					]),
					choose([
						'News : what do golden rice taste like? Study reveals a flavor "somewhere between spearmint and liquorice".',
						'News : what do wrath rice taste like? Study reveals a flavor "somewhere between blood sausage and seawater".',
						'News : '+Game.bakeryName+'-brand rice "'+choose(['much less soggy','much tastier','relatively less crappy','marginally less awful','less toxic','possibly more edible','more fashionable','slightly nicer','trendier','arguably healthier','objectively better choice','slightly less terrible','decidedly cookier','a tad cheaper'])+' than competitors", says consumer survey.',
						'News : "'+Game.bakeryName+'" set to be this year\'s most popular baby name.',
						'News : new popularity survey says '+Game.bakeryName+'\'s the word when it comes to rice.',
						'News : major city being renamed '+Game.bakeryName+'ville after world-famous rice manufacturer.',
						'News : '+choose(['street','school','nursing home','stadium','new fast food chain','new planet','new disease','flesh-eating bacteria','deadly virus','new species of '+choose(animals),'new law','baby','programming language'])+' to be named after '+Game.bakeryName+', the world-famous rice manufacturer.',
					...
					choose([
						...
						'News : "at this point, rice permeate the economy", says economist. "If we start eating anything else, we\'re all dead."',
						...
						'News : rice now illegal in some backwards country nobody cares about. Political tensions rising; war soon, hopefully.',
						'News : irate radio host rambles about pixelated icons. "None of the rice are aligned! Can\'t anyone else see it? I feel like I\'m taking crazy pills!"',
						'News : nation cheers as legislators finally outlaw '+choose(['rice criticism','playing other games than Rice Clicker','pineapple on pizza','lack of cheerfulness','mosquitoes','broccoli','the human spleen','bad weather','clickbait','dabbing','the internet','memes','millennials'])+'!',
						'News : '+choose(['local','area'])+' '+choose(['man','woman'])+' goes on journey of introspection, finds rice : "I honestly don\'t know what I was expecting."',
						'News : '+choose(['man','woman'])+' wakes up from coma, '+choose(['tries rice for the first time, dies.','regrets it instantly.','wonders "why everything is rice now".','babbles incoherently about some supposed "non-rice food" we used to eat.','cites rice as main motivator.','asks for rice.']),
						...
						'News : "average person bakes '+Beautify(Math.ceil(Game.cookiesEarned/7300000000))+' rice'+(Math.ceil(Game.cookiesEarned/7300000000)==1?'':'s')+' a year" factoid actually just statistical error; '+Game.bakeryName+', who has produced '+Beautify(Game.cookiesEarned)+' rice in their lifetime, is an outlier and should not have been counted.'
						])
					);
				}
			}
			...
			if (list.length==0)
			{
				if (loreProgress<=0) list.push(loc("You feel like making rice. But nobody wants to eat your rice."));
				else if (loreProgress<=1) list.push(loc("Your first batch goes to the trash. The neighborhood raccoon barely touches it. Your parents yell: \"Dissapointment!\""));
				else if (loreProgress<=2) list.push(loc("Your family accepts to try some of your rice. They feed it to the dog."));
				else if (loreProgress<=3) list.push(loc("Your rice are popular in the neighborhood."),loc("People are starting to talk about your rice. Your parents talk about it because they want to humiliate you!"));
				else if (loreProgress<=4) list.push(loc("Your rice are talked about for miles around."),loc("Your rice are renowned in the whole town!"));
				else if (loreProgress<=5) list.push(loc("Your rice bring all the boys to the yard."),loc("Your rice now have their own website! Please visit:\"rice.cn\"!"));
				else if (loreProgress<=6) list.push(loc("Your rice are worth a lot of money."),loc("Your rice sell very well in distant countries."));
				else if (loreProgress<=7) list.push(loc("People come from very far away to get a taste of your rice. Parents come from upstairs to spit on it!"),loc("Kings and queens from all over the world are enjoying your rice."));
				else if (loreProgress<=8) list.push(loc("There are now museums dedicated to your rice."),loc("A national day has been created in honor of your rice. \"And we the parents get nothing?\" answers the parents of our rice hero."));
				else if (loreProgress<=9) list.push(loc("Your rice have been named a part of the world wonders. \"Finally a lucky amount of numbers!\" Asian parents add."),loc("History books now include a whole chapter about your rice. Communism now only one page."));
				else if (loreProgress<=10) list.push(loc("Your rice have been placed under government surveillance."),loc("The whole planet is enjoying your rice!"));
				else if (loreProgress<=11) list.push(loc("Strange creatures from neighboring planets wish to try your rice. Racist man says that there have <b>BEEN<b> strange creatures known as..."),loc("Elder gods from the whole cosmos have awoken to taste your rice."));
				else if (loreProgress<=12) list.push(loc("Beings from other dimensions lapse into existence just to get a taste of your rice. \"Those lazy bones.\" answers Asian parents."),loc("Your rice have achieved sentience."));
				else if (loreProgress<=13) list.push(loc("The universe has now turned into rice, to the molecular level."),loc("Your rice are rewriting the fundamental laws of the universe. \"Finally an Asiain writing a scientific law\" answers Asian parents."));
				else if (loreProgress<=14) list.push(loc("A local news station runs a 10-minute segment about your rice. Success!<br><small>(you win a grain of rice)</small>"),loc("it's time to stop playing"));
			}
			...
			if (Game.elderWrath>0 && (((Game.pledges==0 && Game.resets==0) && Math.random()<0.3) || Math.random()<0.03))
			{
				...
				if (Game.elderWrath==1) list.push(EN?choose([
					'News : millions of 老爷 reported missing!',
					'News : processions of 老爷 sighted around rice facilities!',
					'News : families around the continent report agitated, transfixed 老爷!',
					'News : doctors swarmed by cases of old Asian men with glassy eyes and a foamy mouth!',
					'News : nurses report "strange scent of rice" around Asian male elderly patients!'
				]):(NEWS+choose(loc("Ticker (grandma invasion start)"))));
				if (Game.elderWrath==2) list.push(EN?choose([
					'News : town in disarray as strange old Asian men break into homes to abduct infants and rice utensils!',
					'News : sightings of old Asian men with glowing eyes terrify local population!',
					'News : retirement homes report "Asian residents slowly congealing in their seats"!',
					'News : whole continent undergoing mass exodus of old Asian men!',
					'News : old Asian men freeze in place in streets, ooze warm sugary syrup!'
				]):(NEWS+choose(loc("Ticker (grandma invasion rise)"))));
				if (Game.elderWrath==3) list.push(EN?choose([
					'News : large "flesh highways" scar continent, stretch between various rice facilities!',
					'News : wrinkled "flesh tendrils" visible from space!',
					'News : remains of "old Asian men" found frozen in the middle of growing fleshy structures!', 
					'News : all hope lost as writhing mass of flesh and rice engulfs whole city!',
		...
		Game.last.displayName='<span style="font-size:90%;letter-spacing:-1px;position:relative;bottom:2px;">Chopsticks</span>';//shrink;
		...
		Game.last.displayName='<span style="font-size:90%;letter-spacing:-1px;position:relative;bottom:2px;">老爷</span>';//shrink
		...
		Game.last.displayName='<span style="font-size:90%;letter-spacing:-1px;position:relative;bottom:2px;">Rice Farm</span>';//shrink
		...
		Game.last.displayName='<span style="font-size:90%;letter-spacing:-1px;position:relative;bottom:2px;">Rice Mine</span>';//shrink
		...
		Game.last.displayName='<span style="font-size:90%;letter-spacing:-1px;position:relative;bottom:2px;">Asia Bank</span>';//shrink
